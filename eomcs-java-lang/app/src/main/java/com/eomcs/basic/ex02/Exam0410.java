...
public class Exam0410 {
  public static void main(String[] args) {
    ...
    System.out.println(c1.get(Calendar.MONTH)); // month
    System.out.println(c1.get(Calendar.DATE)); // date
    System.out.println(c1.get(Calendar.HOUR)); // hour
    System.out.println(c1.get(Calendar.AM_PM)); // am/ pm
