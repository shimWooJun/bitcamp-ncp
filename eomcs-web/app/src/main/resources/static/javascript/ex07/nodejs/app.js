...
app.get('/exam04-3', (req, res) => {
  ...
  let arr = [
    {no:1,title:'제목11111111111111',writer:'홍길동',viewCnt:19},
    {no:2,title:'제목22222222222222',writer:'임꺽정',viewCnt:312},
    {no:3,title:'제목33333333333',writer:'유관순',viewCnt:31},
    {no:4,title:'제목4444444',writer:'안중근',viewCnt:100},
    {no:5,title:'제목5555555555',writer:'윤봉길',viewCnt:200}
  ];
...
app.get('/proxy2', (req, res) => {    
  ...
  let openApiUrl = "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?" +
    "serviceKey=LLqe8Wy4B%2F15ibQfhKMAawTCtvvkgI7Ld0TfzoJCtPYncvf9iEh9NE39B8yeZ%2Bn5haHfOEStYIZbU7b6Pz7OiQ%3D%3D" + 
    "&pageNo=1" + 
    "&numOfRows=1000" + 
    "&dataType=JSON" + 
